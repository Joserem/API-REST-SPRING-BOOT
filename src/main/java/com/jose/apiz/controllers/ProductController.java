...
import com.jose.apiz.dtos.ProductDto;
...
public class ProductController {
    ...
    public ResponseEntity getById(@PathVariable(value = "id") Integer id) {
        ...
        if (product.isEmpty()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Navio não cadastrado");  
        }
    ...
    public ResponseEntity delete(@PathVariable(value = "id") Integer id){
        ...
        return ResponseEntity.status(HttpStatus.OK).body("Navio deletado");
